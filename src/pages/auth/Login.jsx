import { Button, Flex, FormControl, FormErrorMessage, FormLabel, Heading, Input, InputRightElement, InputGroup, SimpleGrid, Text, Box } from '@chakra-ui/react'
    ...
    return (
        <Flex backgroundImage="url('public/backgroundLeaves.jpeg')"
            ...
            <form onSubmit={handleSubmit(loginAccount)}>
                <Flex background="white" borderRadius="20px"
