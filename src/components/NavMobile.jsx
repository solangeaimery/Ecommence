import { HStack, Heading, SimpleGrid, IconButton, Drawer, DrawerOverlay, DrawerCloseButton, DrawerHeader, DrawerBody, DrawerFooter, Button, useDisclosure, DrawerContent, Menu, MenuButton, MenuList, MenuItem, Image, Box, Flex, Text, Badge } from '@chakra-ui/react'
		...
		<>
			...
			>
				<Flex justifyContent="space-around" alignItems="center">
					<Menu>
						<MenuButton maxW="60px" gap="10px" color="#C0E6C8"
							background="transparent"
							borderRadius="30px"
							_hover={{
								color: "#6A4873",
								background: "#C0E6C8"
							}} as={Button} rightIcon={<ChevronDownIcon fontSize="25px" />}>
							<MdMenu fontSize="25px" />
						</MenuButton>
						<MenuList>
							<MenuItem as={Link} to="/" color="black">Inicio</MenuItem>
							<MenuItem as={Link} to="/productos" color="black">Productos</MenuItem>
							{!user ?
								<>
									<MenuItem as={Link} to="/iniciar-sesion" color="black">Iniciar sesion</MenuItem>
									<MenuItem as={Link} to="/register" color="black">Crear cuenta</MenuItem>
								</>
								:
								<>
									<MenuItem gap="10px" as="button" onClick={handleLogOut} color="black"> <FaUserCircle fontSize="18px" /> Cerrar sesion</MenuItem>
								</>}
						</MenuList>
					</Menu>
